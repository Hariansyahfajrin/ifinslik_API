...
namespace API.Controllers
{
	...
	public class A01Controller(IA01Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IA01Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(A01 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(A01 category)
		{
			try
			{
