...
namespace API.Controllers
{
	...
	public class D01Controller(ID01Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly ID01Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(D01 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(D01 category)
		{
			try
			{
