...
namespace API.Controllers
{
	...
	public class D02Controller(ID02Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly ID02Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(D02 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(D02 category)
		{
			try
			{
