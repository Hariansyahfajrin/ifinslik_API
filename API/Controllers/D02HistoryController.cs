...
namespace API.Controllers
{
	...
	public class D02HistoryController(ID02HistoryService service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly ID02HistoryService _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(D02History id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(D02History category)
		{
			try
			{
