...
namespace API.Controllers
{
	...
	public class F01HistoryController(IF01HistoryService service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IF01HistoryService _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(F01History id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(F01History category)
		{
			try
			{
