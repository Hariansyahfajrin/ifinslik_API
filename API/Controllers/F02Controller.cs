...
namespace API.Controllers
{
	...
	public class F02Controller(IF02Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IF02Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(F02 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(F02 category)
		{
			try
			{
