...
namespace API.Controllers
{
	...
	public class F06Controller(IF06Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IF06Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(F06 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(F06 category)
		{
			try
			{
