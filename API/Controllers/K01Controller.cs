...
namespace API.Controllers
{
	...
	public class K01Controller(IK01Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IK01Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(K01 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(K01 category)
		{
			try
			{
