...
namespace API.Controllers
{
	...
	public class K01HistoryController(IK01HistoryService service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IK01HistoryService _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(K01History id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(K01History category)
		{
			try
			{
