...
namespace API.Controllers
{
	...
	public class M01HistoryController(IM01HistoryService service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IM01HistoryService _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(M01History id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(M01History category)
		{
			try
			{
