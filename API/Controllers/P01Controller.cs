...
namespace API.Controllers
{
	...
	public class P01Controller(IP01Service service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IP01Service _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(P01 id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(P01 category)
		{
			try
			{
