...
namespace API.Controllers
{
	...
	public class P01HistoryController(IP01HistoryService service, IConfiguration configuration) : BaseController(configuration)
	{
		private readonly IP01HistoryService _service = service;
		...
		[HttpPost("Insert")]
		public async Task<ActionResult> Insert(P01History id)
		{
			try
			{
		...
		[HttpPut("UpdateByID")]
		public async Task<ActionResult> UpdateByID(P01History category)
		{
			try
			{
