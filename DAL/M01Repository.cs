...
namespace DAL
{
	public class M01Repository : BaseRepository, IM01Repository
	{

		private readonly string tableBase = "m01";
		private readonly string tableD02 = "d02";
		private readonly string tableCompany = "sys_company";

		public async Task<List<M01>> GetRows(IDbTransaction transaction, string keyword, int offset, int limit, string formTransactionID)
		{
			var p = db.Symbol();
			...
			return await _command.GetRows<M01>(transaction, query, new
			{
				Keyword = $"%{keyword}%",
				Limit = limit,
				Offset = offset,
		...
		public async Task<M01> GetRowByID(IDbTransaction transaction, string id)
		{
			var p = db.Symbol();
			...
			var result = await _command.GetRow<M01>(
		...
		public async Task<int> Insert(IDbTransaction transaction, M01 model)
		{
			var p = db.Symbol();
		...
		public async Task<int> UpdateByID(IDbTransaction transaction, M01 model)
		{
			var p = db.Symbol();
		...
		public Task<List<M01>> GetRows(IDbTransaction transaction, string keyword, int offset, int limit)
		{
