...
namespace DAL
{
	public class P01Repository : BaseRepository, IP01Repository
	{

		private readonly string tableBase = "p01";
		private readonly string tableCompany = "sys_company";
		private readonly string tableD01 = "d01";
		private readonly string tableD02 = "d02";

		public async Task<List<P01>> GetRows(IDbTransaction transaction, string keyword, int offset, int limit, string formTransactionID)
		{
			var p = db.Symbol();
			...
			return await _command.GetRows<P01>(transaction, query, new
			{
				Keyword = $"%{keyword}%",
				Limit = limit,
				Offset = offset,
		...
		public async Task<P01> GetRowByID(IDbTransaction transaction, string id)
		{
			var p = db.Symbol();
			...
			var result = await _command.GetRow<P01>(
		...
		public async Task<int> Insert(IDbTransaction transaction, P01 model)
		{
			var p = db.Symbol();
		...
		public async Task<int> UpdateByID(IDbTransaction transaction, P01 model)
		{
			var p = db.Symbol();
		...
		public Task<List<P01>> GetRows(IDbTransaction transaction, string keyword, int offset, int limit)
		{
